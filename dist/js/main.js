...
/* harmony default export */ __webpack_exports__["default"] = (function (slider, query) {
  ...
  var slidesNumber = slider.activeIndex + slider.params.slidesPerView,
      maxNumber = slider.slides.length;
  /* < 10
  ? '0' + slider.slides.length
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  $(window).on('resize load', function () {
    ...
    var threeLine = $('#tankBenefitsThree');
    var autoLine = $('#tankBenefitsAuto');
    var leftLine = $('#tankBenefitsLeft');
    var qualLine = $('#tankBenefitsQual');
    var hitechLine = $('#tankBenefitsHitech');
    var fastLine = $('#tankBenefitsFast');
    var easyLine = $('#tankBenefitsEasy');
    ...
    function dashed(elem, sign) {
      var box = elem.children('.tankBenefit__item-line');
      var x = box.width();
      var y = box.height();
      var line = box.children('span');
      line.width(Math.sqrt(x * x + y * y) + 'px');
      var atan2 = 57.33 * Math.atan2(y, x);
      line.css('transform', 'rotate(' + sign + atan2 + 'deg)');
    }
  });
});
...
/* harmony import */ var _blocks_resume_resume__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @blocks/resume/resume */ "../views/blocks/resume/resume.js");
/* harmony import */ var _blocks_faq_faq__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @blocks/faq/faq */ "../views/blocks/faq/faq.js");
/* harmony import */ var _blocks_modals_modal_zoom_modal_zoom__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @blocks/modals/modal-zoom/modal-zoom */ "../views/blocks/modals/modal-zoom/modal-zoom.js");
/* harmony import */ var _layouts_modal_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @layouts/modal/modal */ "../views/layouts/modal/modal.js");
// import $ from 'jquery';
...
$(function () {
  ...
  Object(_blocks_resume_resume__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_blocks_faq_faq__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_layouts_modal_modal__WEBPACK_IMPORTED_MODULE_10__["default"])();
});
Object(_blocks_main_services_services__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_blocks_modals_modal_zoom_modal_zoom__WEBPACK_IMPORTED_MODULE_9__["default"])();
